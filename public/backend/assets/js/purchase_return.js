	...
	$(document).on('change', '#product', function() {
	    ...
	    $.ajax({
	        ...
	        success: function(data) {
				...
				var gudang_selector = $("#gudang-selector").html();
				
	            var product_row = `<tr id="product-${item['id']}">
											<td><b>${item['item_name']}</b></td>
											<td class="description"><select class="form-control selectpicker" name="gudang_id[]" title="- Pilih Gudang -" required>${gudang_selector}</select></td>
