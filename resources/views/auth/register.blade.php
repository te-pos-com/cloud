...
<div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('{{url('')}}/public/backend/images/bg_3.webp');"></div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <form method="POST" class="form-signup" autocomplete="off" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <select class="form-control" name="jenis_langganan" id="jenis_langganan" required>
