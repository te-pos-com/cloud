    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h4 class="header-title">{{ _lang('Update Product Merek') }}</h4>
            </div>

            <div class="card-body">
                <div class="col-md-6">
                    <form method="post" class="validate" autocomplete="off"
                        action="{{ action('ProductMerekController@update', $id) }}" enctype="multipart/form-data">
                        {{ csrf_field()}}
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="merek_name"
                                        value="{{ $productmerek->merek_name }}" required>
                                </div>
                            </div>
