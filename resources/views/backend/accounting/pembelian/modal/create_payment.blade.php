<form method="post" class="ajax-submit" autocomplete="off" action="{{ route('pembelian.create_payment') }}"
    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control float-field"
                        value="{{ decimalPlace($pembelian->grand_total-$pembelian->paid) }}" id="pending_amount" readOnly="true">
                </div>
            </div>
            ...
            <input type="hidden" name="pembelian_id" value="{{ $id }}">
