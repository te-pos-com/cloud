...
<body>
    <div id="invoice-view" class="invoice-box pdf p-0">
        <table class="classic-table">
            <tbody>
                <tr>
                    ...
                    <td>
                        <img src="{{ get_pdf_company_logo($quotation->company_id) }}" class="mh-80">
                    </td>
                </tr>
        ...
        @php $currency = get_currency_symbol(get_setting($company,'currency')); @endphp
            ...
            <table class="table table-bordered" id="invoice-summary-table">
                <tbody>
                    <tr>
                        ...
                        <td class="text-right">
                            <b>{!! strip_tags(decimalPlace($quotation->grand_total - $quotation->tax_total, $currency)) !!}</b>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right">{!! strip_tags(decimalPlace($quotation->grand_total, $currency)) !!}</td>
                    </tr>
                </tbody>
            </table>
        </div>
