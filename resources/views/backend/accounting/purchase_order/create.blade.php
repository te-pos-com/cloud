                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="invoice_number"
                                    value="{{ old('invoice_number',get_company_option('invoice_order_pembelian_perfix').get_company_option('invoice_order_pembelian')) }}"
                                    required>
                        ...
                        <div class="col-md-3" hidden>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="order_status" required>
                                    <option value="1" selected="selected">{{ _lang('Ordered') }}</option>
