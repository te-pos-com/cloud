<form method="post" class="ajax-submit" autocomplete="off" action="{{ route('sales_return.create_payment') }}"
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control float-field"
                        value="{{ decimalPlace($sales_return->grand_total-$sales_return->paid) }}" id="pending_amount" readOnly="true">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="reference" value="{{ $sales_return->invoice_number }}">
                </div>
            </div>
            ...
            <input type="hidden" name="sales_return_id" value="{{ $id }}">
