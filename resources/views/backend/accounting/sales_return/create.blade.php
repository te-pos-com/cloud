                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="invoice_number"
                                    value="{{ old('invoice_number',get_company_option('invoice_retur_penjualan_perfix').get_company_option('invoice_retur_penjualan')) }}"
                                    required>
                                <input type="hidden" name="invoice_retur_penjualan"
